...
#created: 2023-08-25 15:00:00
#updated: 2023-08-25 15:00:00
...
function install_base() {
    cat config/vm_conf | grep -v "^#" | grep -v "^$" | while read PhysicalIp ipaddr VirtualName VirtualCPU VirtualMem
    do 
...
function main() {
    echo -e "$CSTART>vm_optimize.sh$CEND"
